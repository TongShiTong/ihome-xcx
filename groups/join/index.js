...
Page({
        ...
        wx.getSetting({
            success: function(t) {
                if (t.authSetting["scope.userInfo"]) {
                    ...
                    } else 0 == e.data.data.more_spec ? (i = e.data.data.id, a.get("groups.goods.goodsCheck", {
                        id: i,
                        type: "group"
                    }, function(t) {
                    ...
                    })) : (i = e.data.data.id, a.get("groups.goods.goodsCheck", {
                        id: i,
                        type: "group"
                    }, function(t) {
    ...
    specsTap: function(t) {
        ...
        a.pdata(t).idx, d[n].item.forEach(function(t, a) {
