var t, a, e = require("../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../@nihaowl/runtime/helpers/defineProperty")), i = getApp(), s = i.requirejs("core"), n = i.requirejs("wxParse/wxParse"), o = i.requirejs("biz/diypage"), r = i.requirejs("biz/diyform"), d = i.requirejs("biz/goodspicker"), u = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((a = {
    ...
    getDiypage: function(t) {
        ...
        u.each(t.diypage.items, function(t, e) {
            if ("topmenu" == e.id) if (a.setData({
                topmenu: e
            }), null == e.data[0]) var i = ""; else i = e.data[0].linkurl, s.get("diypage/getInfo", {
                dataurl: i
            }, function(t) {
    ...
    u.each(i.items, function(t, n) {
        ...
        } else o = -1 != n.data[n.status].linkurl.indexOf("stores") ? "stores" : "goods", 
        r = n.data[n.status].linkurl, d = n.data[n.status].data.length, s.get("diypage/getInfo", {
            dataurl: r,
            num: d,
            paramsType: o
        }, function(t) {
