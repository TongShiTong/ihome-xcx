...
t.requirejs("wxParse/wxParse"), t.requirejs("jquery"), Page({
    ...
    onShow: function() {
        ...
        o && s.setData({
            carrierInfo: o
        }), s.data.addressid, a.id > 0 && (s.addressid = a.id, s.setData({
            addressid: a.id
    ...
    lottery: function() {
        var t = this, a = "";
        0 == t.data.goods.type ? s.get("creditshop/detail/lottery", {
            id: t.data.goods.id,
            logid: t.data.logid
        }, function(s) {
            s.error > 0 ? e.toast(t, s.message) : (2 == s.status && (a = "恭喜您，商品兑换成功"), 3 == s.status && (1 == s.goodstype ? a = "恭喜您，优惠券兑换成功" : 2 == s.goodstype ? a = "恭喜您，余额兑换成功" : 3 == s.goodstype && (a = "恭喜您，红包兑换成功")), 
            t.setData({
                successmessage: a,
                successstatus: !0
            }));
            ...
            s.get("creditshop/detail/lottery", {
                ...
                s.error > 0 ? e.toast(t, s.message) : (2 == s.status ? a = "恭喜您，您中奖啦" : 3 == s.status ? 1 == s.goodstype ? a = "恭喜您，优惠券已经发到您账户啦" : 2 == s.goodstype ? a = "恭喜您，余额已经发到您账户啦" : 3 == s.goodstype && (a = "恭喜您，红包兑换成功") : a = "很遗憾，您没有中奖", 
                t.setData({
                    successmessage: a,
                    successstatus: !0
                }));
