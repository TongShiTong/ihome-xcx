...
Page({
    ...
    getDetail: function() {
        ...
        t.get("member/address/get_detail", {
            ...
            if (i.isEmptyObject(t.detail)) e.data.detail && (console.log(e.data.detail), s = e.data.detail.province + " " + e.data.detail.city + " " + e.data.detail.area, 
            r = e.getIndex(s, e.data.areas), a.pval = r, a.pvalOld = r); else {
