var t, a, e = require("../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../@nihaowl/runtime/helpers/defineProperty")), i = getApp(), s = i.requirejs("core"), n = i.requirejs("wxParse/wxParse"), o = i.requirejs("biz/diypage"), d = i.requirejs("biz/diyform"), u = i.requirejs("biz/goodspicker"), r = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((a = {
    ...
    wx.getSetting({
        success: function(e) {
            e.authSetting["scope.userInfo"] && (u.selectpicker(t, a, "goodslist"), a.setData({
                cover: "",
                showvideo: !1
            }));
        }
...
(0, e.default)(a, "onShareAppMessage", function() {
    ...
    r.each(i.items, function(t, n) {
        ...
        d = n.data[n.status].linkurl, u = n.data[n.status].data.length, s.get("diypage/getInfo", {
            dataurl: d,
            num: u,
            paramsType: o
        }, function(t) {
