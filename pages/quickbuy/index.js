var t, a = require("../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../@nihaowl/runtime/helpers/defineProperty")), e = getApp(), r = e.requirejs("core"), i = e.requirejs("biz/goodspicker"), s = e.requirejs("foxui"), n = e.requirejs("biz/diyform");
...
Page({
    ...
    onLoad: function(t) {
        ...
        n.setData({
            ...
            for (var o = 0; o < n.data.main.group.length; o++) n.data.main.goodsArr[n.data.main.group[o].type] && (s = s + 106 * (n.data.main.goodsArr[n.data.main.group[o].type].length ? n.data.main.goodsArr[n.data.main.group[o].type].length : .6) + 66, 
            a.push(s), n.setData({
                arrscroll: a
            }));
            i = 1 == n.data.main.cartdata ? n.data.pageid : "", r.get("quick/index/getCart", {
                quickid: i
            }, function(t) {
                var a = {};
