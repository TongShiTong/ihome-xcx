var t = require("../../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../../@nihaowl/runtime/helpers/typeof")), e = getApp(), a = e.requirejs("core"), i = e.requirejs("foxui"), r = e.requirejs("biz/diyform"), s = e.requirejs("jquery"), d = e.requirejs("biz/selectdate");
...
Page({
    ...
    onLoad: function(t) {
        ...
        i.setData({
            ...
            if ("" != t.fullbackgoods) {
                ...
                d = Math.round(d), c = Math.round(c), i.setData({
                    fullbackratio: d,
    ...
    toggle: function(t) {
        var e = a.pdata(t), i = e.id, r = {};
        r[e.type] = 0 == i || void 0 === i ? 1 : 0, this.setData(r);
    },
    phone: function(t) {
        a.phone(t);
    },
