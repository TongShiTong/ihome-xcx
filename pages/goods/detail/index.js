var t, e, a = require("../../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../../@nihaowl/runtime/helpers/defineProperty")), o = getApp(), i = o.requirejs("core"), s = (o.requirejs("icons"), 
...
Page((e = {
    ...
    getDetail: function(t) {
        ...
        e.setData({
            ...
            t.goods.istime > 0 && (clearInterval(e.data.timer), r = setInterval(function() {
                ...
                timer: r
            })), t.goods.ispresell > 0 && (r = setInterval(function() {
            ...
            var d = e.data.fullbackgoods;
            if (null != d) {
                var g = d.maxfullbackratio, m = d.maxallfullbackallratio;
                g = Math.round(g), m = Math.round(m), e.setData({
                    maxfullbackratio: g,
    ...
    selectPicker: function(t) {
        ...
        if (this.data.limits) {
            ...
            i = "goodsdetail", d.selectpicker(t, this, i);
        }
    },
    specsTap: function(t) {
        d.specsTap(t, this);
    ...
    select: function() {
        ...
        this.data.diyform, u > 0 && 0 == t ? s.toast(this, "请选择规格") : this.setData({
            active: "",
            slider: "out",
            isSelected: !0,
            tempname: ""
