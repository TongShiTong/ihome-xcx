var a = require("../../@nihaowl/runtime/helpers/interopRequireDefault")(require("../../@nihaowl/runtime/helpers/typeof")), e = getApp(), t = e.requirejs("jquery"), r = e.requirejs("core"), i = e.requirejs("foxui");
...
module.exports = {
    ...
    verify: function(a, e) {
        for (var r in e.fields) {
            ...
            if (6 == d.data_type && !/(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/.test(e.f_data[n])) return i.toast(a, "请填写正确的" + d.tp_name), 
            !1;
