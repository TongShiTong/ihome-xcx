    ...
    selectpicker: function(o, d, i, s) {
        ...
        "" == r && d.setData({
            ...
            if (t.goods.presellstartstatus || null == t.goods.presellstartstatus || "1" != t.goods.ispresell) if (t.goods.member_discount > 0 && d.setData({
                ...
                if ("goodsdetail" == i) if (d.setData({
                ...
                }), 0 != t.goods.minbuy && d.data.total < t.goods.minbuy) var r = t.goods.minbuy; else r = d.data.total; else d.setData({
                    pickerOption: t,
                    goods: t.goods,
                    options: a,
                    minpicker: i
                    ...
                    specsData: [],
                    specs: []
                }), r = 0 != t.goods.minbuy && d.data.total < t.goods.minbuy ? t.goods.minbuy : 1;
                t.diyform && d.setData({
                    diyform: {
